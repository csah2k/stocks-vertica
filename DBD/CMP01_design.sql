CREATE PROJECTION stocks.daily_prices_DBD_1_rep_CMP01 /*+createtype(D)*/
(
...
CREATE PROJECTION stocks.stock_symbols_DBD_2_rep_CMP01 /*+createtype(D)*/
(
...
CREATE PROJECTION stocks.daily_prices_cvcbsa_training_DBD_3_rep_CMP01 /*+createtype(D)*/
(
...
CREATE PROJECTION stocks.daily_prices_cvcbsa_simulation_DBD_4_rep_CMP01 /*+createtype(D)*/
(
 ts ENCODING COMMONDELTA_COMP, 
 symbol ENCODING RLE, 
...
CREATE PROJECTION stocks.daily_prices_cvcbsa_prediction_DBD_5_rep_CMP01 /*+createtype(D)*/
(
 ts ENCODING COMMONDELTA_COMP, 
 symbol ENCODING RLE, 
 open ENCODING COMMONDELTA_COMP, 
